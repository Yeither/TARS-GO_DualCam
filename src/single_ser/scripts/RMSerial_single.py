...
def listener():
    ...
    while not rospy.is_shutdown():
        ...
        data_list,send_sentry = safe_bet(down_data,state)
        ...
        sentry_guess_up_down_map = map_ui(send_sentry,state,down_map,3,10)
