...
if state == 'R':
    loaded_arrays = np.load('/home/yang/double_camera/src/detect2/scripts/npy/arrays_test_red.npy')  # 加载标定好的仿射变换矩阵
    map_image = cv2.imread("/home/yang/double_camera/src/detect2/scripts/images/map_red.jpg")  # 加载红方视角地图
    mask_image = cv2.imread("/home/yang/double_camera/src/detect2/scripts/images/map_mask.jpg")  # 加载红发落点判断掩码
    hide_mask = cv2.imread('/home/yang/double_camera/src/detect2/scripts/images/hide_mask.jpg')
else:
    loaded_arrays = np.load('/home/yang/double_camera/src/detect2/scripts/npy/arrays_test_blue.npy')  # 加载标定好的仿射变换矩阵
    map_image = cv2.imread("/home/yang/double_camera/src/detect2/scripts/images/map_blue.jpg")  # 加载蓝方视角地图
    mask_image = cv2.imread("/home/yang/double_camera/src/detect2/scripts/images/map_mask.jpg")  # 加载蓝方落点判断掩码
    hide_mask = cv2.imread('/home/yang/double_camera/src/detect2/scripts/images/hide_mask.jpg')
...
# 加载战场地图
map_backup = cv2.imread("/home/yang/double_camera/src/detect2/scripts/images/map.jpg")
map = map_backup.copy()
...
weights_path = '/home/yang/double_camera/src/detect2/scripts/models/car_m.engine'
weights_path_next = '/home/yang/double_camera/src/detect2/scripts/models/armor.engine'
detector = YOLOv5Detector(weights_path, data='/home/yang/double_camera/src/detect2/scripts/yaml/car.yaml',conf_thres=0.2, iou_thres=0.2, max_det=14, ui=True)
detector_next = YOLOv5Detector(weights_path_next,data='/home/yang/double_camera/src/detect2/scripts/yaml/armor.yaml', conf_thres=0.20, iou_thres=0.2,max_det=1,ui=True)
