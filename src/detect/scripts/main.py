...
sys.path.insert(0, "/home/yang/double_camera/src/detect/scripts")
...
def ser_send(pub):
    ...
    target_position_ROS = Serial_Send_Down()
    ...
    def send_point(target_position,if_guess):
        try:
            target_position_ROS.position_1_down = target_position[0]
            target_position_ROS.position_2_down = target_position[1]
            target_position_ROS.position_3_down = target_position[2]
            target_position_ROS.position_4_down = target_position[3]
            target_position_ROS.position_7_down = target_position[5]
